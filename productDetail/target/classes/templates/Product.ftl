...
<title>${title?default("正在加载中...")}</title>
</head>
<body>  
<!--Begin Header Begin-->
<div class="top">
...
<div class="i_bg">
	<div class="postion">
    	<span class="fl">${title?default("正在加载中...")}</span>
    </div>    
    <div class="content">
    	                    
        <div id="tsShopContainer">
            <div id="tsImgS"><a href="${imgUrl}" title="Images" class="MagicZoom" id="MagicZoom">
                    <img src="${imgUrl}" width="390" height="390" /></a></div>
        ...
        <div class="pro_des">
        	<div class="des_name">
            	<p>${title?default("正在加载中...")}</p>
                ${subtitle?default("正在加载中...")}
            </div>
            <div class="des_price">
            	本店价格：<b>${price?default("正在加载中...")}</b><br />
            </div>
            <div class="des_choice">
            	<span class="fl">型号选择：</span>
                <ul>
                	<li class="checked">${type?default("正在加载中...")}<div class="ch_img"></div></li>
                </ul>
            </div>
            <div class="des_choice">
            	<span class="fl">颜色选择：</span>
                <ul>
                    <li class="checked">${color?default("正在加载中...")}<div class="ch_img"></div></li>
                </ul>
            </div>
            <div class="des_share">
            	<div class="d_sh">
    ...
    <div class="content mar_20">
        ...
        <div class="l_list">        	
            ...
            <div class="des_border">
                <div class="des_tit">
                	<ul>
                        ...
                        <li id="comment"><a href="#p_comment">商品评论</a></li>
                    </ul>
                </div>
            ...
            <div class="des_border" id="p_comment">
                ...
                <table id="discuss" border="0" class="jud_list" style="width:100%; margin-top:30px;" cellspacing="0" cellpadding="0">
                      <#--<tr valign="top">
                        <td width="160">
    ...
    <script type="text/javascript">
        jQuery(function(){
            ...
            jQuery("#comment").click(function(){
                jQuery.ajax({
                    url:"http://localhost:2020/discussConsumer/discuss/getDiscuss",
                    type:"post",
                    dataType:"json",
                    data:{
                    ...
                    success:function (result) {
                        ...
                        var contents = "";
                        if(status=="0"){
                            var discussList = result.discussList;
                            for(var i in discussList){
                                var content = discussList[i].content;
                                var createDate = discussList[i].createDate;
                                var color = discussList[i].color;
                                var type = discussList[i].type;
                                var headIconUrl = discussList[i].headIconUrl;
                                var flag = discussList[i].flag;
                                var userId = discussList[i].userId;
                                var uName = discussList[i].uName;
                                contents = contents + "<tr valign=\"top\">\n" +
                                    "<td width=\"160\">\n" +
                                    "<img src='"+headIconUrl+"' width=\"20\" height=\"20\" align=\"absmiddle\" />&nbsp;"+uName+"\n" +
                                    "</td>\n" +
                                    "<td width=\"180\">\n" +
                                    "颜色分类：<font color=\"#999999\">"+color+"</font> <br />\n" +
                                    "型号：<font color=\"#999999\">"+type+"</font>\n" +
                                    "</td>\n" +
                                    "<td>\n" +
                                    ""+content+" <br />\n" +
                                    "<font color=\"#999999\">"+createDate+"</font>\n" +
                                    "</td>\n" +
                                    "</tr>";
                            }
                            jQuery("#discuss").html(contents);
                        }else {
                            alert("获取评论失败");
                        }
                    },
